        ...
        <ul class="offcanvas-cart-list">
            <li>
                ...
                <div class="offcanvas-cart-item">
                    <div class="offcanvas-cart-item__thumbnail">
                        <a href="#">
                            <img src="theme/client/assets/images/products/product-02.jpg" width="70" height="84" alt="product" />
                        </a>
                    </div>
            ...
            <li>
                ...
                <div class="offcanvas-cart-item">
                    <div class="offcanvas-cart-item__thumbnail">
                        <a href="#">
                            <img src="theme/client/assets/images/products/product-04.jpg" width="70" height="84" alt="product" />
                        </a>
                    </div>
                    <div class="offcanvas-cart-item__content">
                        <h4 class="offcanvas-cart-item__title">
            ...
            <li>
                ...
                <div class="offcanvas-cart-item">
                    <div class="offcanvas-cart-item__thumbnail">
                        <a href="#">
                            <img src="theme/client/assets/images/products/product-05.jpg" width="70" height="84" alt="product" />
                        </a>
                    </div>
                    <div class="offcanvas-cart-item__content">
                        <h4 class="offcanvas-cart-item__title">
...
<div class="offcanvas offcanvas-end offcanvas-sidebar" tabindex="-1" id="offcanvasSidebar">
    ...
    <div class="offcanvas-body">
        ...
        <div class="offcanvas-sidebar__banner" style="
                background-image: url(theme/client/assets/images/shop-sidebar-banner.jpg);
            ">
                        ...
                        <div class="mega-menu__banner">
                            <a href="#">
                                <div class="mega-menu__banner--image">
                                    <img src="theme/client/assets/images/megamenu.jpg" alt="Fashion Banner" width="269" height="271" />
                                </div>
            ...
            <div class="swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="slider-item home-1-slider-style-1 swiper-slide d-md-flex align-items-center home-1-slider-animation" style="
                                    background-image: url(theme/client/assets/images/slider/slider-1.jpg);
                                ">
                    ...
                    <!-- Slider Item Start -->
                    <div class="slider-item home-1-slider-style-1 swiper-slide d-md-flex align-items-center home-1-slider-animation" style="
                                    background-image: url(theme/client/assets/images/slider/slider-2.jpg);
                                ">
                        <!-- Slider Content Start -->
                    ...
                    <!-- Slider Item Start -->
                    <div class="slider-item home-1-slider-style-1 swiper-slide d-md-flex align-items-center home-1-slider-animation" style="
                                    background-image: url(theme/client/assets/images/slider/slider-3.jpg);
                                ">
                        <!-- Slider Content Start -->
                        <div class="home-1-slider-content-style-1">
                            <h3 class="home-1-slider-content-style-1__sub-title">
            ...
            <div class="row custom-g-2 banner-grid">
                    ...
                    <div class="banner-item banner-1 js-scroll ShortFadeInUp">
                        <a href="#">
                            <div class="banner-item__image">
                                <img src="theme/client/assets/images/banner/banner-1.jpg" alt="Banner" />
                            </div>
                ...
                <div class="col-lg-4 col-sm-6 grid-item">
                    ...
                    <div class="banner-item banner-2 js-scroll ShortFadeInUp">
                        <a href="#">
                            <div class="banner-item__image">
                                <img src="theme/client/assets/images/banner/banner-2.jpg" alt="Banner" width="453" height="266" loading="lazy" />
                            </div>
                ...
                <div class="col-lg-4 col-sm-6 grid-item">
                    ...
                    <div class="banner-item banner-2 js-scroll ShortFadeInUp">
                        <a href="#">
                            <div class="banner-item__image">
                                <img src="theme/client/assets/images/banner/banner-3.jpg" alt="Banner" width="453" height="266" loading="lazy" />
                            </div>
                            <div class="banner-item__content text-center">
                                <h3 class="banner-item__title">
                                    Take a photo
                ...
                <div class="col-lg-4 col-sm-6 grid-item">
                    ...
                    <div class="banner-item banner-3 js-scroll ShortFadeInUp">
                        <a href="#">
                            <div class="banner-item__image">
                                <img src="theme/client/assets/images/banner/banner-4.jpg" alt="Banner" width="453" height="266" loading="lazy" />
                            </div>
                            <div class="banner-item__content text-center">
                                <h3 class="banner-item__title">
                                    Fresh food
                ...
                <div class="col-lg-4 col-sm-6 grid-item">
                    ...
                    <div class="banner-item banner-4 js-scroll ShortFadeInUp">
                        <a href="#">
                            <div class="banner-item__image">
                                <img src="theme/client/assets/images/banner/banner-5.jpg" alt="Banner" width="453" height="266" loading="lazy" />
                            </div>
                            <div class="banner-item__content text-center">
                                <h3 class="banner-item__title">
                                    Kute Toys
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    ...
                                    <div class="single-product__thumbnail--holder">
                                        <a href="">
                                            <img src="{{ Storage::url($product->img_thumb) }}" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
...
<!-- 
    ...
    <div class="product-section section-padding-1">
        <div class="container-fluid custom-container">
            ...
            <div class="section-title text-center js-scroll ShortFadeInUp">
                <span class="section-title__icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="58.981" height="56.016" viewBox="0 0 58.981 56.016">
                        <g fill="currentColor">
                            <path d="M46.588 12.288v-1a1.211 1.211 0 1 0-2.422 0v1a1.211 1.211 0 1 0 2.422 0M29.49 56.017c15.845 0 26.57-4.746 29.424-13.02a1.211 1.211 0 0 0-2.29-.79c-2.5 7.237-12.386 11.388-27.135 11.388S4.613 49.35 2.364 42.238a1.211 1.211 0 1 0-2.308.73c2.622 8.293 13.35 13.05 29.433 13.05">
                            </path>
                            <path d="M14.814 48.873a1.211 1.211 0 0 0 1.211-1.211c0-6.973 5.537-11.843 13.465-11.843s13.47 4.869 13.47 11.842a1.211 1.211 0 0 0 2.422 0c0-8.4-6.534-14.265-15.887-14.265s-15.887 5.866-15.887 14.265a1.211 1.211 0 0 0 1.211 1.211M13.599 24.342a1.208 1.208 0 0 0-1.433.937L7.972 45.307a1.211 1.211 0 0 0 2.37.5l4.194-20.028a1.211 1.211 0 0 0-.937-1.433">
                            </path>
                            <path d="M45.868 1.242A1.211 1.211 0 0 0 44.658 0 10.45 10.45 0 0 0 34.22 10.438v6.455H14.861a7.238 7.238 0 0 0-7.2 6.341c-.843 6.983-4.661 8.545-4.85 8.618a1.211 1.211 0 0 0 .825 2.277c.219-.079 5.392-2.019 6.429-10.6a4.814 4.814 0 0 1 4.8-4.21h4.536c.29 9.648 4.105 10.446 9.037 10.446 4.958 0 8.208-.811 8.208-11.657v-7.666a8.029 8.029 0 0 1 6.771-7.92l-.095 3.656a1.21 1.21 0 0 0 .881 1.2l9.876 2.8c.812.265 1.353.889 1.353 3.072a3.546 3.546 0 0 1-3.566 3.231h-.067l-7.634.424a1.211 1.211 0 0 0-1.119 1.451l5.6 27.449a1.211 1.211 0 1 0 2.373-.484l-5.316-26.075 6.2-.344a5.979 5.979 0 0 0 5.952-5.653c0-1.2 0-4.389-3.071-5.388l-9.016-2.554Zm-17.435 26.1c-3.811 0-6.387-.006-6.616-8.024h12.388c-.17 8.018-2.1 8.024-5.772 8.024">
                            </path>
                        </g>
                    </svg>
                </span>

                <h2 class="section-title__title">Toys</h2>
            </div>
            <!-- Section Title End -->
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    ...
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-14.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-12.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    ...
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-15.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-16.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-11.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
            ...
            <!-- More Button Start -->
            <div class="text-center js-scroll ShortFadeInUp">
                <a class="view-more-btn" href="#">View more Toys</a>
            </div>
            <!-- More Button End -->
        </div>
    </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    ...
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-08.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-01.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    ...
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-13.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-17.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-07.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    ...
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-18.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-19.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    ...
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-23.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-10.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-22.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    ...
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-21.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-09.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    ...
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-20.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-product js-scroll ShortFadeInUp">
                                <div class="single-product__thumbnail">
                                    <div class="single-product__thumbnail--holder">
                                        <a href="product-single.html">
                                            <img src="theme/client/assets/images/products/product-05.jpg" alt="Product" width="344" height="370" />
                                        </a>
                                    </div>
                                    <div class="single-product__thumbnail--meta-2">
                                        <a href="#" data-bs-tooltip="tooltip" data-bs-placement="top" data-bs-title="Add to cart" data-bs-custom-class="p-meta-tooltip" aria-label="cart"><i class="lastudioicon-shopping-cart-3"></i></a>
        ...
        <div class="container-fluid custom-container">
            ...
            <div class="newsletter-home-wrapper">
                ...
                <div class="newsletter-layer-1 js-scroll ShortFadeInUp">
                    <img src="theme/client/assets/images/layer-1.png" alt="Layer" width="216" height="160" loading="lazy" />
                </div>
                <div class="newsletter-layer-2 js-scroll ShortFadeInUp">
                    <img src="theme/client/assets/images/layer-2.png" alt="Layer" width="187" height="203" loading="lazy" />
                </div>
            </div>
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="category-item js-scroll ShortFadeInUp">
                                <a href="#">
                                    <div class="category-item__image">
                                        <img src="theme/client/assets/images/category/category-1.jpg" alt="Category" width="344" height="300" loading="lazy" />
                                    </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="category-item js-scroll ShortFadeInUp">
                                <a href="#">
                                    <div class="category-item__image">
                                        <img src="theme/client/assets/images/category/category-2.jpg" alt="Category" width="344" height="300" loading="lazy" />
                                    </div>
                                    <div class="category-item__content">
                                        <span class="category-item__btn">
                                            Play and learn
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="category-item js-scroll ShortFadeInUp">
                                <a href="#">
                                    <div class="category-item__image">
                                        <img src="theme/client/assets/images/category/category-3.jpg" alt="Category" width="344" height="300" loading="lazy" />
                                    </div>
                                    <div class="category-item__content">
                                        <span class="category-item__btn">
                                            Soft Clothing
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="category-item js-scroll ShortFadeInUp">
                                <a href="#">
                                    <div class="category-item__image">
                                        <img src="theme/client/assets/images/category/category-4.jpg" alt="Category" width="344" height="300" loading="lazy" />
                                    </div>
                                    <div class="category-item__content">
                                        <span class="category-item__btn">
                                            Decor & Toy
                ...
                <div class="swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <div class="client-item text-center js-scroll ShortFadeInUp">
                                <div class="client-item__user">
                                    <img src="theme/client/assets/images/user/user-1.jpg" alt="User" width="60" height="60" loading="lazy" />
                                </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="client-item text-center js-scroll ShortFadeInUp">
                                <div class="client-item__user">
                                    <img src="theme/client/assets/images/user/user-2.jpg" alt="User" width="60" height="60" loading="lazy" />
                                </div>
                                <div class="client-item__comment">
                                    <p>
                                        Out of all themes I purchased
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="client-item text-center js-scroll ShortFadeInUp">
                                <div class="client-item__user">
                                    <img src="theme/client/assets/images/user/user-3.jpg" alt="User" width="60" height="60" loading="lazy" />
                                </div>
                                <div class="client-item__comment">
                                    <p>
                                        Out of all themes I purchased
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="instagram-item js-scroll ShortFadeInUp">
                            <a href="#">
                                <div class="instagram-item__image">
                                    <img src="theme/client/assets/images/instagram/instagram-1.jpg" alt="Instagram" />
                                </div>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="instagram-item js-scroll ShortFadeInUp">
                            <a href="#">
                                <div class="instagram-item__image">
                                    <img src="theme/client/assets/images/instagram/instagram-2.jpg" alt="Instagram" />
                                </div>
                                <div class="instagram-item__icon">
                                    <i class="lastudioicon-b-instagram"></i>
                                </div>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="instagram-item js-scroll ShortFadeInUp">
                            <a href="#">
                                <div class="instagram-item__image">
                                    <img src="theme/client/assets/images/instagram/instagram-3.jpg" alt="Instagram" />
                                </div>
                                <div class="instagram-item__icon">
                                    <i class="lastudioicon-b-instagram"></i>
                                </div>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="instagram-item js-scroll ShortFadeInUp">
                            <a href="#">
                                <div class="instagram-item__image">
                                    <img src="theme/client/assets/images/instagram/instagram-4.jpg" alt="Instagram" />
                                </div>
                                <div class="instagram-item__icon">
                                    <i class="lastudioicon-b-instagram"></i>
                                </div>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="instagram-item js-scroll ShortFadeInUp">
                            <a href="#">
                                <div class="instagram-item__image">
                                    <img src="theme/client/assets/images/instagram/instagram-5.jpg" alt="Instagram" />
                                </div>
                                <div class="instagram-item__icon">
                                    <i class="lastudioicon-b-instagram"></i>
                                </div>
