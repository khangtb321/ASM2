                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <div class="login-register">
                            <h3 class="login-register__title justif">Log In</h3>
                            ...
                            <form action="{{ route('login.post') }}" method="post">
                                ...
                                <div class="login-register__form">
                                    ...
                                    <div class="single-form">
                                        <input class="single-form__input" name="email" id="email" type="text" placeholder="Username or email address *" />
                                    </div>
                                    <!-- Single Form Start -->
                                    <!-- Single Form Start -->
                                    <div class="single-form">
                                        <input class="single-form__input" name="password" id="email" type="password" placeholder="Password *" />
                                    </div>
                                    <!-- Single Form Start -->
                                    <!-- Single Form Start -->
                                    <div class="single-form">
                            ...
                            <ul class="login-register__social">
                                <li>
                                    <a class="social-facebook" href="#">
                                        <span class="social-icon">
                                                <img
                                                    src="theme/client/assets/images/facebook.svg"
                                                    alt="Facebook"
                                                />
                                            </span>
                                ...
                                <li>
                                    <a class="social-google" href="#">
                                        <span class="social-icon">
                                                <img
                                                    src="theme/client/assets/images/google.svg"
                                                    alt="Facebook"
                                                />
                                            </span>
                                        <span class="social-text"
