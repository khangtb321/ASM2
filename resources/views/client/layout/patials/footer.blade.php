<div class="container-fluid custom-container">
			...
			<div class="footer-main">
				<div class="row">
					<div class="col-lg-5">
						<!-- Footer About Start -->
						<div class="footer-about text-center mx-xxl-0 mx-auto">
							<a class="footer-about__logo justify-content-xxl-start justify-content-center" href="#">
								<img src="theme/client/assets/images/logo.png" alt="Logo" width="145" height="36" loading="lazy" />
							</a>
							<p>
						...
						<div class="footer-link">
							<div class="footer-link__wrapper">
								...
								<ul class="footer-link__list">
									...
									<li>
										<a href="term-of-use.html">Help Center</a>
									</li>
									<li>
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						<div class="text-center text-md-end">
							<img src="theme/client/assets/images/footer-payment-1.png" alt="Footer Payment" width="230" height="17"
								loading="lazy" />
						</div>
					</div>
				</div>
