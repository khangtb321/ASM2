                            ...
                            <form action="" method="POST">
                                ...
                                <div class="login-register__form">
                                    ...
                                    <div class="single-form">
                                        <input class="single-form__input" type="text" placeholder="Ten *" name="name" />
                                    </div>
                                    <div class="single-form">
                                        <input class="single-form__input" type="email" placeholder="Email address *" name="email" />
                                    </div>
                                    <!-- Single Form Start -->
                                    <!-- Single Form Start -->
                                    <div class="single-form">
                                        <input class="single-form__input" type="password" placeholder="Password *" name="password"/>
                                    </div>
