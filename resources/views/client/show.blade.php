        ...
        <ul class="offcanvas-cart-list">
            <li>
                ...
                <div class="offcanvas-cart-item">
                    <div class="offcanvas-cart-item__thumbnail">
                        <a href="#">
                            <img src="{{asset('assets/images/products/product-02.jpg')}}" width="70" height="84" alt="product" />
                        </a>
                    </div>
            ...
            <li>
                ...
                <div class="offcanvas-cart-item">
                    <div class="offcanvas-cart-item__thumbnail">
                        <a href="#">
                            <img src="{{asset('assets/images/products/product-04.jpg')}}" width="70" height="84" alt="product" />
                        </a>
                    </div>
                    <div class="offcanvas-cart-item__content">
                        <h4 class="offcanvas-cart-item__title">
            ...
            <li>
                ...
                <div class="offcanvas-cart-item">
                    <div class="offcanvas-cart-item__thumbnail">
                        <a href="#">
                            <img src="{{asset('assets/images/products/product-05.jpg')}}" width="70" height="84" alt="product" />
                        </a>
                    </div>
                    <div class="offcanvas-cart-item__content">
                        <h4 class="offcanvas-cart-item__title">
...
<div class="offcanvas offcanvas-end offcanvas-sidebar" tabindex="-1" id="offcanvasSidebar">
    ...
    <div class="offcanvas-body">
        ...
        <div class="offcanvas-sidebar__banner" style="
                background-image: url(asset/assets/images/shop-sidebar-banner.jpg);
            ">
                        ...
                        <div class="mega-menu__banner">
                            <a href="#">
                                <div class="mega-menu__banner--image">
                                    <img src="{{asset('/assets/images/megamenu.jpg')}}" alt="Fashion Banner" width="269" height="271" />
                                </div>
...
<main>
                            ...
                            <div class="swiper">
                                <div class="swiper-wrapper">
                                    <div class="product-single-slide-item swiper-slide">
                                        <img src="{{asset('/assets/images/products/product-single-01.jpg')}}" alt="Product single" width="694" height="728" />
                                    </div>
                                    <div class="product-single-slide-item swiper-slide">
                                        <img src="{{asset('/assets/images/products/product-single-02.jpg')}}" alt="Product single" width="694" height="728" />
                                    </div>
                                    <div class="product-single-slide-item swiper-slide">
                                        <img src="{{asset('/assets/images/products/product-single-03.jpg')}}" alt="Product single" width="694" height="728" />
                                    </div>
                                    <div class="product-single-slide-item swiper-slide">
                                        <img src="{{asset('/assets/images/products/product-single-04.jpg')}}" alt="Product single" width="694" height="728" />
                                    </div>
                                </div>
                                ...
                                <div class="product-single-zoom">
                                    <div class="zoom">
                                        <a class="product-glightbox" href="{{asset('assets/images/products/product-single-01.jpg')}}" aria-label="zoom image"></a>
                                        <a class="product-glightbox" href="{{asset('assets/images/products/product-single-02.jpg')}}" aria-label="zoom image"></a>
                                        <a class="product-glightbox" href="{{asset('assets/images/products/product-single-03.jpg')}}" aria-label="zoom image"></a>
                                        <a class="product-glightbox" href="{{asset('assets/images/products/product-single-04.jpg')}}" aria-label="zoom image"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="swiper">
                                <div class="swiper-wrapper">
                                    <div class="product-single-thumb-item swiper-slide">
                                        <img src="{{asset('assets/images/products/product-single-01.jpg')}}" alt="Product single" width="144" height="155" />
                                    </div>
                                    <div class="product-single-thumb-item swiper-slide">
                                        <img src="{{asset('assets/images/products/product-single-02.jpg')}}" alt="Product single" width="144" height="155" />
                                    </div>
                                    <div class="product-single-thumb-item swiper-slide">
                                        <img src="{{asset('assets/images/products/product-single-03.jpg')}}" alt="Product single" width="144" height="155" />
                                    </div>
                                    <div class="product-single-thumb-item swiper-slide">
                                        <img src="{{asset('assets/images/products/product-single-04.jpg')}}" alt="Product single" width="144" height="155" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="product-single-tab-description">
                                    ...
                                    <div class="product-single-tab-description-item">
                                        ...
                                        <p>
                                            <img src="{{asset('/assets/images/content-single-product-image-2.png')}}" alt="Product Icon" width="150" height="33" loading="lazy" />
                                        </p>
                                    </div>
                                    <!-- Product Single Tab Description Item End -->
                                </div>
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="product-single-tab-image">
                                    ...
                                    <div class="product-single-tab-image__image">
                                        ...
                                        <img src="theme/client/assets/images/content-single-product-image-1.jpg" alt="product-image" width="320" height="218" loading="lazy" />
                                    </div>
                                </div>
                                ...
                                <ul class="comment-items">
                                    ...
                                    <li class="comment-item">
                                        <div class="comment-item__author">
                                            <img src="{{asset('/assets/images/user/user-1.jpg')}}" alt="Author" width="90" height="90" loading="lazy" />
                                        </div>
                                    ...
                                    <li class="comment-item">
                                        <div class="comment-item__author">
                                            <img src="theme/client/assets/images/user/user-2.jpg" alt="Author" width="90" height="90" loading="lazy" />
                                        </div>
                                        <div class="comment-item__content">
                                            <div class="comment-item__rating">
                                                <span class="star-rating">
                                    ...
                                    <li class="comment-item">
                                        <div class="comment-item__author">
                                            <img src="theme/client/assets/images/user/user-3.jpg" alt="Author" width="90" height="90" loading="lazy" />
                                        </div>
                                        <div class="comment-item__content">
                                            <div class="comment-item__rating">
                                                <span class="star-rating">
    ...
    <div class="newsletter-section">
        <div class="newsletter-left" style="background-image: url(theme/client/assets/images/newsletter-bg-1.jpg)">
        ...
        <div class="newsletter-right" style="background-image: url(theme/client/assets/images/newsletter-bg-2.jpg)">
            <!-- Newsletter Wrapper Start -->
            <div class="newsletter-wrapper text-center">
